...
export const useSiteStore = create(
  persist(
    (set) => ({
      ...
      aboutHeroSubtitle: "We're just a couple of humans who think dogs are better than people. Dogle started because we wanted a place where our own pups wouldn't just stay, but actually play. Warning: We might love your dog more than you do.",
    ...
    {
      name: "dogle-site-storage", // name of the item in the storage (must be unique)
    }
  )
);
